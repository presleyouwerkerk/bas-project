...
<body>
    ...
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
        <div class="form-group">
            ...
            <input id="artOmschrijving" class="field" type="text" name="artOmschrijving" placeholder="Artikel omschrijving">
        </div>
        ...
        <div class="form-group">
            ...
            <input id="artMinVoorraad" class="field" type="number" name="artMinVoorraad" placeholder="Minimale voorraad">
        </div>

        <div class="form-group">
            <label for="artMaxVoorraad">Maximum voorraad:</label>
            <input id="artMaxVoorraad" class="field" type="number" name="artMaxVoorraad" placeholder="Maximale voorraad">
        </div>

        <div class="form-group">
            <label for="artLocatie">Magazijn locatie:</label>
            <input id="artLocatie" class="field" type="number" name="artLocatie" placeholder="Locatie">
        </div>
